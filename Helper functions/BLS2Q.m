function Out = BLS2Q(DISPLAY,tBLS,t,Z,dZ,na,Ca,R,rhol,PecQ,Q0,DeltaQ,psiQ,Pin,Pm,Po,PaT,omega,PS,delta0,mus,mul,S,Da,ka,A,B,deltaR)
if DISPLAY == 2
...
Out = [dZ;
(-3/(2*R(Z)))*dZ^2+1/(rhol*abs(R(Z)))*(Pin(na,Z)+PecQ(Q,Z)+...
