function Out = SONIC_MSN_nanoMC(ESi,USPaT,DISPLAY,tNICE,t,Q1,h1,m1,n1,p1,Q2,h2,m2,n2,p2,Gna,Vna,Gk,Vk,Gl,Vl,Vm,f1Veff0,f1VeffPa,f1rt0,f1rtPa,f1rtV,SONICgates,Cm0,aBLS,fBLS,RSI)
if DISPLAY == 1
...
Out1 = [ESi(t)+10^(-3)*(1/(pi*aBLS^2*RSI))*(Veff2-Veff1)-10^(-3)*(Gl*(Veff-Vl)+Gna*m1.^3.*h1.*(Veff1-Vna)+...
    Gk*n1.^4.*(Veff1-Vk)+Gk*p1.*(Veff1-Vm));
