function Out = SONIC_MSN_nanoMC(ESi,USPaT,DISPLAY,tNICE,t,Q1,h1,m1,n1,p1,Q2,h2,m2,n2,p2,Gna,Vna,Gk,Vk,Gl,Vl,Vm,f1Veff0,f1VeffPa,f1rt0,f1rtPa,f1rtV,SONICgates,Cm0,aBLS,fBLS,RSI,proteinMode,gateMultip)
if DISPLAY == 1
...
Out2 = [ESi(t)+10^(-3)*(1/(pi*aBLS^2*(1/fBLS-1)*RSI))*(Veff1-Veff2)-10^(-3)*(Ml*Gl*(Veff2-Vl)+MP*Gna*m2.^3.*h2.*(Veff2-Vna)+...
    MP*Gk*n2.^4.*(Veff2-Vk)+MP*Gk*p2.*(Veff2-Vm));
