...
funPES(num2str(Tsim),'2',num2str(USps),num2str(USpd),num2str(USfreq{i}(iFreq)),num2str(USdc),num2str(USprf),...
...
elseif pathNum == 2
    ...
    for iFreq = 1:length(USfreqRange)
        for iaBLS = 1:length(aBLSRange)
            ...
            elseif pathNum == 2
            funPES(num2str(Tsim),'2',num2str(USps),num2str(USpd),num2str(USfreqRange(iFreq)),num2str(USdc),num2str(USprf),...
...
% NICE around threshold
cd(NICEpath);
funPES(num2str(Tsim),'2',num2str(USps),num2str(USpd),num2str(USfreq),num2str(USdc),num2str(USprf{i}(iprf)),...
...
elseif pathNum == 2
    ...
    for idc = 1:length(USdcRange)
        for iprf = 1:length(USprfRange)
            ...
            elseif pathNum == 2
            funPES(num2str(Tsim),'2',num2str(USps),num2str(USpd),num2str(USfreq),num2str(USdcRange(idc)),num2str(USprfRange(iprf)),...
