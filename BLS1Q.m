function Out = BLS1Q(DISPLAY,tBLS,t,Z,dZ,na,R,rhol,PecQ,Q0,Pin,Pm,Po,PaT,omega,PS,delta0,mus,mul,S,Da,Ci,ka,ksi) %#ok<INUSL>
if DISPLAY==2
...
Out = [dZ;
(-3/(2*R(Z)))*dZ^2+1/(rhol*abs(R(Z)))*(PecQ(Q0,Z)+Pin(na,Z)+...
