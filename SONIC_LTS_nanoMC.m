function Out = SONIC_LTS_nanoMC(ESi,USPaT,DISPLAY,tNICE,t,Q1,h1,m1,n1,p1,s1,u1,Q2,h2,m2,n2,p2,s2,u2,Gna,Vna,Gk,Vk,Gm,GT,VCa,Gl,Vl,f1Veff0,f1VeffPa,f1rt0,f1rtPa,f1rtV,SONICgates,Cm0,aBLS,fBLS,RSI,proteinMode,gateMultip)
if DISPLAY == 1
...
Out2 = [ESi(t)+10^(-3)*(1/(pi*aBLS^2*(1/fBLS-1)*RSI))*(Veff1-Veff2)-10^(-3)*(MP*Gna*m2^3*h2*(Veff2-Vna)+MP*Gk*n2^4*(Veff2-Vk)+MP*Gm*p2*(Veff2-Vk)+MP*GT*s2^2*u2*(Veff2-VCa)+Ml*Gl*(Veff2-Vl));
